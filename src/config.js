...
export const CLIENT_VERSION='namioshi-v3.3.0-official004';
export const SCORE_UNIT='点';
export const PLAY_SECONDS=30;
export const MAX_TAPS=10;
export const SCORE_HARD_CEILING=10800;
...
export const OFFICIAL_RULE_VERSION='namioshi-v3-strategy-003';
export const RANKING_SEASON='prelaunch-v3';
