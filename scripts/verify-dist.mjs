...
walk('dist');if(bad.length){console.error(bad.join('\n'));process.exit(1)}console.log('verify ok: no source maps, external CDN, service_role, direct ranking_scores POST, CSS direct import, three bare import, or legacy hand-written dist markers');
