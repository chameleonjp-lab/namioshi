...
現行mainのマージコミットは`4cea23ea7257d0618ba1a8be184d8f9997e90a8a`です。PR #85はマージ済みで、次の修正はDraft PRで確認します。
...
PR #85のマージ後に、描画が一時的に遅れて反射エフェクトを発生から80ms以上経って初めて観測した場合でも、寿命内ならHAMENへ一度だけ投入するよう補修しました。これにより、遅延だけを理由にリアル水面波が欠落する経路を減らします。物理・得点・入力上限は変更しません。
