...
- 構造上限は10根波×3ビーコン×360点 = 10800点。旧6回・6480点は歴史資料であり、端末ベスト・ranking seasonと混ぜない。
- 現行ルール版は`namioshi-v3-strategy-003`、client versionは`namioshi-v3.3.0-official004`、seasonは`prelaunch-v3`。
