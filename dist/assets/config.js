...
export const CLIENT_VERSION='namioshi-v3.2.0-official003';
...
export const OFFICIAL_RULE_VERSION='namioshi-v3-strategy-002';
export const RANKING_SEASON='prelaunch-v2';
