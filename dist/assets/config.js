...
export const CLIENT_VERSION='namioshi-v3.4.0-official005';
...
export const OFFICIAL_RULE_VERSION='namioshi-v3-reflection-tap-004';
export const RANKING_SEASON='prelaunch-v4';
